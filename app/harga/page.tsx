...
const TIERS = [
  {
    ...
    feats: [
      "Website Builder + Optimasi AI (SEO / GEO / social search)",
      "12 listing live — halaman & skor GEO per unit",
      "Listing, testimoni & profil asli",
      "Editor Studio — 10 build video/bulan",
      "Konten harian — 2 per hari + jadwal terbit",
      "Assets bebas royalti + 3 voice · Skor Cakra",
    ],
    cta: "Mulai sekarang",
    href: "/onboarding",
    hi: true,
  },
  {
    ...
    price: "Segera hadir",
    per: "",
    tagline: "Skala penuh & pertumbuhan tingkat lanjut.",
    status: "soon" as const,
    feats: [
      "Semua di Pro, plus:",
      "100 listing live",
      "Halaman per menu + advertorial (seperti cakra.xyz)",
      "20 build/bulan · 3 konten harian",
      "Inbox terpadu (unified inbox)",
      "Analitik media sosial, kalender & prospek",
    ],
    cta: "Beri tahu saya",
    href: "/contact",
    hi: false,
  },
  {
    ...
    status: "soon" as const,
    feats: [
      "Semua di Business, untuk banyak agen:",
