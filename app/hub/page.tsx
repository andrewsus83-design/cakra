...
const ARTICLES: Article[] = [
  ...
  { id: 9, cat: "Konten", title: "Menulis deskripsi listing yang menjual", excerpt: "Formula sederhana: rasa, fakta, ajakan. Plus contoh sebelum–sesudah.", img: "/blog-2.webp", read: "4 menit", author: "Andi Pratama", likes: 71, body: ["Buka dengan rasa (bayangkan pagi di teras ini), lanjut dengan fakta (3 kamar, hadap timur), tutup dengan ajakan yang jelas.", "Hindari klise. Detail spesifik yang jujur jauh lebih meyakinkan daripada kata sifat berlebihan."] },
  { id: 10, cat: "AI", title: "Reputasi digital: menabung kepercayaan", excerpt: "Ulasan, konsistensi, dan rekam jejak yang bekerja untuk Anda bahkan saat sedang tidur.", img: "/about/invite.webp", read: "5 menit", author: "Sarah Wijaya", likes: 66, body: ["Reputasi adalah bunga majemuk. Setiap ulasan baik dan konten bermanfaat menambah saldo kepercayaan yang berbunga seiring waktu.", "Minta ulasan pada momen bahagia — tepat setelah serah terima kunci."] },
  { id: 11, cat: "Pasar", title: "Suku bunga & daya beli properti 2026", excerpt: "Bagaimana pergerakan suku bunga memengaruhi keputusan pembeli — dan cara menjelaskannya dengan tenang.", img: "/blog-2.webp", read: "6 menit", author: "Budi Santoso", likes: 44, body: ["Perubahan suku bunga menggeser daya beli, terutama pada segmen KPR. Pembeli yang cemas mencari agen yang menenangkan dengan angka, bukan janji.", "Siapkan simulasi cicilan pada beberapa skenario bunga. Kejelasan membangun kepercayaan."] },
  { id: 12, cat: "Tips", title: "Skrip follow-up WhatsApp yang tak memaksa", excerpt: "Tiga pesan lanjutan yang menjaga percakapan tetap hangat tanpa terasa mengejar.", img: "/blog-0.webp", read: "4 menit", author: "Sarah Wijaya", likes: 89, body: ["Follow-up yang baik memberi nilai, bukan tekanan. Kirim informasi baru — bukan sekadar “sudah dipikirkan, Kak?”.", "Beri jeda yang sopan dan selalu tutup dengan satu langkah kecil yang mudah dijawab."] },
  { id: 13, cat: "Ditemukan", title: "Google Business Profile untuk agen properti", excerpt: "Cara muncul di peta dan pencarian lokal saat pembeli menelusuri area Anda.", img: "/hero-top.webp", read: "5 menit", author: "Budi Santoso", likes: 51, body: ["Profil bisnis yang lengkap dan aktif membuat Anda muncul saat orang mencari “agen properti dekat sini”.", "Perbarui foto, jawab ulasan, dan tautkan ke website Anda agar sinyal lokal makin kuat."] },
  ...
  { id: 15, cat: "Konten", title: "Tur properti 60 detik dari 10 foto", excerpt: "Alur sederhana mengubah foto listing menjadi video yang membuat pembeli datang lebih siap.", img: "/about/transform.webp", read: "5 menit", author: "Sarah Wijaya", likes: 77, body: ["Urutkan foto sesuai alur kunjungan: fasad, ruang utama, kamar, lalu momen terbaik sebagai penutup.", "Tambahkan teks singkat dan musik lembut. AI merangkainya menjadi tur 60 detik dalam menit."] },
  { id: 16, cat: "AI", title: "Etika memakai AI dalam pemasaran properti", excerpt: "Batas yang menjaga kepercayaan: transparansi, akurasi, dan sentuhan manusia.", img: "/punch.webp", read: "6 menit", author: "Andi Pratama", likes: 62, body: ["AI mempercepat pekerjaan, tetapi klaim tetap harus akurat dan foto tidak menyesatkan. Kepercayaan lebih mahal dari kecepatan.", "Gunakan AI untuk draf dan ide; biarkan penilaian akhir tetap di tangan Anda."] },
];
