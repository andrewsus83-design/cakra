...
const ARTICLES: Article[] = [
  { id: 1, cat: "Pasar", title: "Panduan harga properti Canggu 2026", excerpt: "Tren harga tanah dan vila di kawasan pertumbuhan baru Bali — dan apa artinya bagi pembeli Anda.", img: "/about/hero.webp", read: "8 menit", author: "Tim cakra", likes: 128, featured: true, body: ["Canggu terus menjadi magnet investasi properti di Bali. Dalam dua tahun terakhir, harga tanah di koridor Berawa–Pererenan naik dua digit, didorong permintaan vila sewa dan hunian ekspatriat.", "Bagi agen, ini berarti dua hal: pembeli semakin teredukasi, dan kecepatan informasi menentukan siapa yang dipercaya. Konten pasar yang rapi membuat Anda tampak sebagai rujukan, bukan sekadar perantara.", "Kuncinya bukan menurunkan harga, melainkan menjelaskan nilai — lokasi, legalitas, dan potensi imbal hasil — dengan bahasa yang menenangkan pembeli."] },
  { id: 2, cat: "Tips", title: "5 cara video listing menaikkan closing", excerpt: "Mengapa satu video 60 detik mengalahkan 20 foto — dan cara membuatnya dalam hitungan menit dengan AI.", img: "/blog-1.webp", read: "5 menit", author: "Tim cakra", likes: 96, featured: true, body: ["Video memberi konteks yang tidak bisa ditangkap foto: alur ruangan, cahaya, dan skala. Pembeli yang menonton video listing tinggal lebih lama dan datang ke viewing dengan niat lebih kuat.", "Dengan AI, video 45–90 detik bisa dibuat dari foto dan deskripsi dalam menit — lengkap dengan gerak sinematik dan musik. Fokuskan 3 detik pertama pada momen terbaik properti."] },
  { id: 3, cat: "Ditemukan", title: "SEO lokal & pencarian AI untuk agen", excerpt: "Agar nama Anda muncul saat calon pembeli mencari “agen properti di area Anda” — di Google dan AI.", img: "/about/vision.webp", read: "6 menit", author: "Tim cakra", likes: 74, featured: true, body: ["Pencarian berubah. Banyak pembeli kini bertanya ke asisten AI sebelum membuka marketplace. Yang disebut adalah agen dengan kehadiran paling jelas dan konsisten.", "GEO — optimasi untuk mesin pencari generatif — dimulai dari konten yang menjawab pertanyaan nyata pembeli, ditulis rapi dan kredibel di website Anda sendiri."] },
  { id: 4, cat: "Konten", title: "Kalender konten 30 hari untuk agen sibuk", excerpt: "Rencana posting yang realistis: apa yang ditulis, kapan, dan bagaimana AI meringankan bebannya.", img: "/about/origin.webp", read: "7 menit", author: "Tim cakra", likes: 58, body: ["Konsistensi mengalahkan intensitas. Satu posting bernas per pekan lebih kuat daripada sepuluh dalam sehari lalu senyap sebulan.", "Bagi konten menjadi tiga jenis: edukasi pasar, cerita properti, dan bukti sosial. AI membantu menyusun draf; sentuhan Anda membuatnya terpercaya."] },
  { id: 5, cat: "AI", title: "Apa itu GEO, dan kenapa agen harus peduli", excerpt: "Mesin pencari AI mulai menjawab langsung. Inilah cara memastikan jawabannya menyebut Anda.", img: "/punch.webp", read: "5 menit", author: "Tim cakra", likes: 141, body: ["GEO (Generative Engine Optimization) adalah seni membuat konten Anda mudah dikutip oleh asisten AI. Kalimat yang jelas dan definitif lebih mungkin dijadikan jawaban.", "Mulailah dari halaman area dan FAQ yang menjawab pertanyaan pembeli secara langsung — itulah bahan baku yang dibaca mesin AI."] },
  { id: 6, cat: "Studi Kasus", title: "Dari tak terlihat jadi rujukan dalam 90 hari", excerpt: "Bagaimana seorang agen kawasan membangun presence dan menutup lebih banyak lewat website sendiri.", img: "/about/transform.webp", read: "9 menit", author: "Tim cakra", likes: 87, body: ["Awalnya semua lead datang dari marketplace. Dalam tiga bulan membangun website, konten area, dan reputasi, arus lead langsung mulai tumbuh.", "Yang berubah bukan hanya jumlah lead, tetapi kualitasnya — pembeli datang sudah mengenal dan mempercayai."] },
  { id: 7, cat: "Tips", title: "Foto properti: 8 kesalahan yang menurunkan minat", excerpt: "Cahaya, sudut, dan urutan. Perbaikan kecil yang membuat listing terlihat jauh lebih mahal.", img: "/hero.webp", read: "6 menit", author: "Tim cakra", likes: 63, body: ["Foto pertama menentukan klik. Pilih bidikan dengan cahaya alami terbaik dan komposisi paling lapang.", "Hindari lensa terlalu lebar yang mendistorsi ruangan — kepercayaan pembeli lebih berharga daripada kesan luas yang menyesatkan."] },
  { id: 8, cat: "Pasar", title: "Program 3 Juta Rumah: peluang bagi agen", excerpt: "Permintaan hunian melonjak. Bagaimana memposisikan diri di segmen yang sedang tumbuh.", img: "/blog-0.webp", read: "7 menit", author: "Tim cakra", likes: 52, body: ["Dorongan penyediaan rumah membuka segmen pembeli pertama yang besar. Agen yang paham skema pembiayaan menjadi pemandu yang dicari.", "Konten yang menjelaskan proses dengan sabar akan menarik pembeli yang belum percaya diri."] },
  { id: 9, cat: "Konten", title: "Menulis deskripsi listing yang menjual", excerpt: "Formula sederhana: rasa, fakta, ajakan. Plus contoh sebelum–sesudah.", img: "/blog-2.webp", read: "4 menit", author: "Tim cakra", likes: 71, body: ["Buka dengan rasa (bayangkan pagi di teras ini), lanjut dengan fakta (3 kamar, hadap timur), tutup dengan ajakan yang jelas.", "Hindari klise. Detail spesifik yang jujur jauh lebih meyakinkan daripada kata sifat berlebihan."] },
  { id: 10, cat: "AI", title: "Reputasi digital: menabung kepercayaan", excerpt: "Ulasan, konsistensi, dan rekam jejak yang bekerja untuk Anda bahkan saat sedang tidur.", img: "/about/invite.webp", read: "5 menit", author: "Tim cakra", likes: 66, body: ["Reputasi adalah bunga majemuk. Setiap ulasan baik dan konten bermanfaat menambah saldo kepercayaan yang berbunga seiring waktu.", "Minta ulasan pada momen bahagia — tepat setelah serah terima kunci."] },
  { id: 11, cat: "Pasar", title: "Suku bunga & daya beli properti 2026", excerpt: "Bagaimana pergerakan suku bunga memengaruhi keputusan pembeli — dan cara menjelaskannya dengan tenang.", img: "/blog-2.webp", read: "6 menit", author: "Tim cakra", likes: 44, body: ["Perubahan suku bunga menggeser daya beli, terutama pada segmen KPR. Pembeli yang cemas mencari agen yang menenangkan dengan angka, bukan janji.", "Siapkan simulasi cicilan pada beberapa skenario bunga. Kejelasan membangun kepercayaan."] },
  { id: 12, cat: "Tips", title: "Skrip follow-up WhatsApp yang tak memaksa", excerpt: "Tiga pesan lanjutan yang menjaga percakapan tetap hangat tanpa terasa mengejar.", img: "/blog-0.webp", read: "4 menit", author: "Tim cakra", likes: 89, body: ["Follow-up yang baik memberi nilai, bukan tekanan. Kirim informasi baru — bukan sekadar “sudah dipikirkan, Kak?”.", "Beri jeda yang sopan dan selalu tutup dengan satu langkah kecil yang mudah dijawab."] },
  { id: 13, cat: "Ditemukan", title: "Google Business Profile untuk agen properti", excerpt: "Cara muncul di peta dan pencarian lokal saat pembeli menelusuri area Anda.", img: "/hero-top.webp", read: "5 menit", author: "Tim cakra", likes: 51, body: ["Profil bisnis yang lengkap dan aktif membuat Anda muncul saat orang mencari “agen properti dekat sini”.", "Perbarui foto, jawab ulasan, dan tautkan ke website Anda agar sinyal lokal makin kuat."] },
  { id: 14, cat: "Studi Kasus", title: "Satu artikel area, dua belas lead", excerpt: "Bagaimana panduan lingkungan yang jujur menarik pembeli serius sepanjang kuartal.", img: "/about/vision.webp", read: "7 menit", author: "Tim cakra", likes: 103, body: ["Sebuah panduan area yang menjawab pertanyaan nyata — sekolah, akses, harga — menjadi magnet pencarian.", "Karena ditulis rapi dan kredibel, artikel itu terus bekerja dan dikutip bahkan oleh asisten AI."] },
  { id: 15, cat: "Konten", title: "Tur properti 60 detik dari 10 foto", excerpt: "Alur sederhana mengubah foto listing menjadi video yang membuat pembeli datang lebih siap.", img: "/about/transform.webp", read: "5 menit", author: "Tim cakra", likes: 77, body: ["Urutkan foto sesuai alur kunjungan: fasad, ruang utama, kamar, lalu momen terbaik sebagai penutup.", "Tambahkan teks singkat dan musik lembut. AI merangkainya menjadi tur 60 detik dalam menit."] },
  { id: 16, cat: "AI", title: "Etika memakai AI dalam pemasaran properti", excerpt: "Batas yang menjaga kepercayaan: transparansi, akurasi, dan sentuhan manusia.", img: "/punch.webp", read: "6 menit", author: "Tim cakra", likes: 62, body: ["AI mempercepat pekerjaan, tetapi klaim tetap harus akurat dan foto tidak menyesatkan. Kepercayaan lebih mahal dari kecepatan.", "Gunakan AI untuk draf dan ide; biarkan penilaian akhir tetap di tangan Anda."] },
];
    ...
    <main>
      ...
      <section style={{ position: "relative", minHeight: "62vh", display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, WebkitMaskImage: "linear-gradient(180deg, #000 78%, transparent 100%)", maskImage: "linear-gradient(180deg, #000 78%, transparent 100%)" }}>
          ...
          <img src="/about/origin.webp" alt="Meja kerja hangat — wawasan dan konten untuk agen properti" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
      ...
      <section className="wrap" style={{ padding: "22px 0 84px" }}>
        ...
        <div className="card" data-hubsub style={{ marginTop: 40, padding: "clamp(34px, 5vw, 60px)", background: "var(--surface-2)", borderColor: "color-mix(in oklab, var(--brand) 24%, var(--line))", display: "grid", gridTemplateColumns: "1.15fr .85fr", gap: "clamp(28px, 4vw, 48px)", alignItems: "center" }}>
          ...
          <div className="hubsub-icon" style={{ borderRadius: 16, overflow: "hidden", aspectRatio: "1 / 1", boxShadow: "var(--shadow-soft)" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/subscribe.webp" alt="Buletin cakra — amplop dengan segel kuningan" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
          </div>
        </div>
