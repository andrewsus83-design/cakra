...
const FAQ_SECTIONS: { title: string; items: { q: string; a: string }[] }[] = [
  {
    ...
    items: [
      ...
      { q: "Untuk siapa cakra dibuat?", a: "Untuk agen properti yang ingin membangun brand dan presence sendiri — terutama agen berkinerja tinggi yang menargetkan penjualan 1M+ per bulan. Cocok untuk agen independen maupun yang tergabung di sebuah agensi." },
  ...
  },
  {
    ...
    items: [
      { q: "Berapa biayanya?", a: "cakra bisa dimulai gratis. Paket berbayar membuka fitur lanjutan seperti video AI, domain, dan konten otomatis. Detail paket ditampilkan saat Anda mendaftar." },
      { q: "Apakah ada masa coba gratis?", a: "Ya. Anda bisa mulai gratis dan menjelajah fitur inti sebelum memilih paket berbayar." },
      { q: "Bisakah saya berhenti kapan saja?", a: "Bisa. Langganan bulanan tanpa kontrak jangka panjang — berhenti kapan saja, tanpa penalti." },
    ],
  },
  {
    title: "Data & Keamanan",
      ...
      <section className="wrap" style={{ padding: "8px 0 88px" }}>
        <div className="card" style={{ padding: "clamp(28px, 5vw, 48px)", textAlign: "center", background: "var(--surface-2)", borderColor: "color-mix(in oklab, var(--brand) 22%, var(--line))" }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <Link href="/signup" className="btn btn-brand" style={{ fontSize: "1rem", padding: ".85rem 1.6rem" }}>Mulai gratis</Link>
          </div>
        </div>
      </section>
