...
// English pre-rendered per-agent GEO page (/s/<sub>/en) — 100% English (labels + advertorial.en),
// hreflang-linked to the Indonesian page. Crawlable static HTML.
