...
const VALUES = [
  ...
  ["Tepercaya", "Kredibel di mata calon pembeli"],
  ["Mudah dihubungi", "WhatsApp & form di tiap halaman"],
  ["Cepat & profesional", "Video & artikel dalam menit"],
  ["Selalu ditemukan", "Peringkat naik di Google, AI & sosial"],
];

const STEPS = [
  ["Jawab 20 pertanyaan", "Onboarding singkat bergaya Typeform memahami area, tipe properti, dan target pembeli Anda — fondasi semua konten yang dipersonalisasi."],
  ...
  return (
    <main>
      ...
      <section style={{ position: "relative", minHeight: "100svh", display: "grid", placeItems: "center", overflow: "hidden" }}>
        ...
        <div className="wrap" style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "110px 0 96px" }}>
          <span className="hand" style={{ fontSize: "2rem", color: "var(--brand)", display: "inline-block", transform: "rotate(-2deg)" }}>
            pemasaran properti, disederhanakan
          </span>
          <h1 className="display on-photo" style={{ fontWeight: 700, fontSize: "clamp(3rem, 6.6vw, 5.6rem)", margin: "6px auto 0", maxWidth: "18ch", lineHeight: 1.02 }}>
            Jadi agen yang selalu ditemukan — dan dipercaya.
          </h1>
          <p className="on-photo-soft" style={{ margin: "26px auto 0", maxWidth: "56ch", fontSize: "1.3rem", lineHeight: 1.55 }}>
            cakra membangun website profesional Anda, memproduksi video dan artikel listing dengan AI, lalu menaikkan
          ...
          <p className="on-photo-soft" style={{ marginTop: 26, fontSize: ".98rem" }}>
            <span style={{ color: "var(--brand)" }}>★</span> Dibuat untuk agen berkinerja tinggi — yang menargetkan penjualan <b className="on-photo" style={{ textShadow: "none" }}>1M+ per bulan</b>.
          </p>
        </div>
      </section>
        ...
        <div className="card" data-punch style={{ marginTop: 48, overflow: "hidden", display: "grid", gridTemplateColumns: "1.05fr .95fr", background: "var(--surface-2)", borderColor: "color-mix(in oklab, var(--brand) 24%, var(--line))" }}>
          <div style={{ padding: "clamp(28px, 4vw, 52px)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <p className="muted" style={{ fontSize: "1.1rem", lineHeight: 1.6, marginTop: 16, maxWidth: "46ch" }}>
              Bangun website, konten, dan reputasi milik Anda sendiri — presence yang dikenali manusia maupun mesin pencari AI, dan tak bisa diabaikan.
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "26px 40px", marginTop: 28 }}>
              {[
                { n: "9,9 juta", l: "backlog rumah nasional menanti pembeli", c: "--c-solar" },
                { n: "Jutaan", l: "pencarian properti online tiap bulan", c: "--c-eye" },
                { n: "1M+", l: "target penjualan agen papan atas per bulan", c: "--c-heart" },
              ].map((s) => (
                <div key={s.l}>
            ...
            <div style={{ marginTop: 30 }}>
              <Link href="/signup" className="btn btn-brand" style={{ fontSize: "1.02rem", padding: ".85rem 1.6rem" }}>Bangun presence Anda sekarang</Link>
            </div>
          </div>
      ...
      <section id="cara-kerja" style={{ padding: "72px 0" }}>
        <div className="wrap">
          <SectionTitle hand="tiga langkah, itu saja" max="20ch">Dari formulir singkat ke halaman pertama pencarian.</SectionTitle>
      ...
      <section className="wrap" style={{ padding: "24px 0 80px" }}>
        <div className="card" style={{ overflow: "hidden", padding: 0 }}>
          <div style={{ display: "flex", gap: 6, padding: "13px 18px", borderBottom: "1px solid var(--line)", alignItems: "center" }}>
            ...
            <i style={{ width: 10, height: 10, borderRadius: 999, background: "var(--line-2)" }} />
            <i style={{ width: 10, height: 10, borderRadius: 999, background: "var(--line-2)" }} />
            <span className="mono muted" style={{ marginLeft: 8, fontSize: ".78rem" }}>rania-putri.cakra.xyz</span>
          </div>
          <div style={{ position: "relative", aspectRatio: "16 / 7.6", background: "var(--surface-2)" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/hero.jpg" alt="Contoh website agen properti yang dibuat dengan cakra" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            ...
            <div style={{ position: "absolute", left: "6%", bottom: "13%", maxWidth: "44ch", color: "#fff" }}>
              <span className="eyebrow" style={{ color: "#f0e6cf" }}>Rania Putri · Bali Property</span>
              <h3 className="display" style={{ fontSize: "clamp(1.8rem, 3.4vw, 2.7rem)", fontWeight: 600, margin: "10px 0 6px", color: "#fff" }}>
                Rumah yang menjaga cahaya — dan nilainya.
              </h3>
              <span className="hand" style={{ fontSize: "1.6rem", color: "#e9cf9a" }}>website Anda, siap dalam hitungan hari</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="wrap" style={{ padding: "40px 0 88px" }}>
        <div className="card" style={{ padding: "clamp(30px, 5vw, 56px)", background: "var(--surface-2)", display: "grid", gridTemplateColumns: "1.05fr .95fr", gap: 48, alignItems: "center" }} data-presence>
          <div>
            <span className="hand gold" style={{ fontSize: "1.8rem", display: "inline-block", transform: "rotate(-2deg)" }}>satu skor yang jelas</span>
            <h2 className="display" style={{ fontWeight: 700, fontSize: "clamp(2rem, 3.6vw, 2.9rem)", margin: "8px 0 16px", maxWidth: "20ch", lineHeight: 1.04 }}>
              Tujuh pusat kehadiran, dalam satu skor.
            </h2>
            <p className="muted" style={{ maxWidth: "54ch", margin: "0 0 22px", fontSize: "1.1rem" }}>
              cakra mengukur kehadiran online Anda pada tujuh pusat — dari website hingga reputasi. Lihat skor total Anda
              dan rinciannya sekilas, lalu biarkan konten yang platform buat menaikkannya minggu demi minggu.
            </p>
            <CenterPills />
          </div>
        ...
        <div className="card" data-sub style={{ overflow: "hidden", display: "grid", gridTemplateColumns: ".82fr 1.18fr", background: "var(--surface-2)", borderColor: "color-mix(in oklab, var(--brand) 22%, var(--line))" }}>
          ...
          <div style={{ padding: "clamp(32px, 4.5vw, 60px)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <h2 className="display" style={{ fontWeight: 700, fontSize: "clamp(2rem, 3.6vw, 3rem)", margin: "6px 0 12px", maxWidth: "18ch", lineHeight: 1.06 }}>
              Update pasar & tips real estate, tiap minggu.
            </h2>
            <p className="muted" style={{ maxWidth: "46ch", margin: "0 0 26px", fontSize: "1.08rem", lineHeight: 1.6 }}>
              Tren pasar, ide pemasaran, dan perkembangan AI untuk agen properti — langsung ke email Anda.
            </p>
            <form style={{ display: "flex", gap: 10, maxWidth: 500, flexWrap: "wrap" }}>
              ...
              <button type="button" className="btn btn-brand" style={{ padding: ".95rem 1.8rem", fontSize: "1rem" }}>Langganan gratis</button>
            </form>
